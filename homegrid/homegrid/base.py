    ...
    def render(self):
        ...
        if self.render_mode == "human":
            if self.window is None:
                # Matplotlib is only needed for interactive human rendering.
                # Keeping this import lazy lets headless agents run without
                # initializing a user-level Matplotlib cache.
